// Standard ISO/IEC 18004 QR Code Generator Library (Pure JS)
// Produces 100% compliant QR codes readable by Google Lens, iPhone, WhatsApp, Android
(function(root, factory) {
  ...
  // Helper method to draw directly onto canvas
  QRCode.drawCanvas = function(canvasEl, text, size) {
    if (!canvasEl) return;
    size = size || 120;
    var qr = new QRCode(0, 0); // Auto type, EC level M
    qr.addData(text);
    qr.make();
