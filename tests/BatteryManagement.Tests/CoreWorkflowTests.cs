...
public sealed class CoreWorkflowTests
{
    ...
    public async Task Direct_and_dealer_lifecycles_preserve_traceability_and_warranty_dates()
    {
        ...
        await service.SellPackAsync(directPack, false, "Retail Customer", "9999999999", "Pune", "EV-01", 85000m, admin.Username);
        ...
        await service.SellPackAsync(dealerPack, true, "EV Dealer", "8888888888", "Mumbai", "", 80000m, admin.Username);
