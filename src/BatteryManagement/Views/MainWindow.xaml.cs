...
public partial class MainWindow : Window
{
    ...
    private List<BatteryModel> _models = [];
    private List<ComponentBatch> _batches = [];
    private List<BatteryPack> _packs = [];
    private List<WarrantyClaim> _claims = [];
    private readonly DispatcherTimer _syncTimer = new() { Interval = TimeSpan.FromMinutes(5) };
